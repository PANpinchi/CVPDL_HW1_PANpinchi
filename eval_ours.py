...
def calculate_map_for_thresholds(pred_data, gt_data):
    thresholds = [0.5, 0.75]
    mAP_results = {}

    # mAP(50-95)
    mAP_50_95 = calculate_map_per_instance(pred_data, gt_data)
    mAP_results["mAP(50-95)"] = mAP_50_95

    # mAP for each threshold (e.g., AP50 and AP75)
    for threshold in thresholds:
        specific_threshold_map = calculate_map_per_instance(pred_data, gt_data, iou_thresholds=[threshold])
        mAP_results[f"AP{int(threshold * 100)}"] = specific_threshold_map
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Evaluate mAP50-95, AP50, AP75 for object detection.')
    ...
    # Calculate and print mAP results
    mAP_results = calculate_map_for_thresholds(pred_json, gt_json)
